...
public class DistributeKey extends HttpServlet
{
	...
	private static  String fromEmailId="ehrproject243@gmail.com";
	private static  String password="ehrproject2432021";
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)throws ServletException, IOException 
	{
		...
		try
		{
			...
			secreteKeyInfo = userId+"-"+deptCode1+"-"+deptCode2+"-"+designCode1+"-"+designCode2;
