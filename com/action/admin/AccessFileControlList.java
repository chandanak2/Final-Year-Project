	...
	public void doGet(HttpServletRequest request,HttpServletResponse response)throws IOException
	{
		...
		try
		{
			...
			if(submit.equals("get"))
			{
				...
				rd=request.getRequestDispatcher("/Resources/JSP/Admin/accesscontrols.jsp?no=1");
			...
			if(submit.equals("Add"))
			{
				if(Utility.parse1(request.getParameter("add1")).equals("YES"))
				{
					...
					if(result)
					{
						rs = adminDAO.getAccessControls();
						request.setAttribute("rs", rs);
						rd=request.getRequestDispatcher("/Resources/JSP/Admin/accesscontrols.jsp?no=1&no1=1");
						rd.forward(request, response);
					}
					else
					{
						rd=request.getRequestDispatcher("/Resources/JSP/Admin/accesscontrols.jsp?no=2&no1=2");
						rd.forward(request, response);
					}
				...
				{
					rd=request.getRequestDispatcher("/Resources/JSP/Admin/accesscontrols.jsp?no=2");
					rd.forward(request, response);
				}
			}
			...
			if(submit.equals("Edit"))
			{
				...
				if(Utility.parse1(request.getParameter("edit1")).equals("YES"))
				{
					...
					rs = adminDAO.getAccessControls();
					request.setAttribute("rs", rs);
					rd=request.getRequestDispatcher("/Resources/JSP/Admin/accesscontrols.jsp?no=1&no1=2");
					rd.forward(request, response);
				}
				else if(chk==null)
				{
					rs = adminDAO.getAccessControls();
					request.setAttribute("rs", rs);
					rd=request.getRequestDispatcher("/Resources/JSP/Admin/accesscontrols.jsp?no=1&no1=3");
					rd.forward(request, response);
				}
				else if(chk.length!=1)
				{
					rs = adminDAO.getAccessControls();
					request.setAttribute("rs", rs);
					rd=request.getRequestDispatcher("/Resources/JSP/Admin/accesscontrols.jsp?no=1&no1=4");
					rd.forward(request, response);
				}
				else if(chk.length==1)
				{
					...
					request.setAttribute("rs", rs);
					rd=request.getRequestDispatcher("/Resources/JSP/Admin/accesscontrols.jsp?no=3");
					rd.forward(request, response);
				}
			}
			...
			if(submit.equals("Delete"))
			{
				...
				else
				{
					...
					rs = adminDAO.getAccessControls();
					request.setAttribute("rs", rs);
					rd=request.getRequestDispatcher("/Resources/JSP/Admin/accesscontrols.jsp?no=1&no1=5");
					rd.forward(request, response);
				}
			}
		}
