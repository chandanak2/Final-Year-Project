...
public class SendMailAttachment {
	...
	public static boolean sendPersonalizedMail(String recipient, String subject,String message,String filename)  
	{
		...
		boolean debug = true;
		String from="indprojectemail1@gmail.com";
		try
		{
			...
			Session session = Session.getInstance(props,	new javax.mail.Authenticator() 
			{
				...
				{
					return new PasswordAuthentication("indprojectemail1@gmail.com", "*projectemail1123");
				}
			});
	...
	public static void main(String args[]) throws MessagingException, Exception
	{
		...
		sendPersonalizedMail("ashwini@dhsinformatics.com", "jhedgwejkgdwed", "dfdfdfdf", "no");
	}
